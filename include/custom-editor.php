...
// エディターにランキングフォーマットボタン追加
function cps_register_button($buttons){
	$path = get_template_directory_uri();
	?>
	<input class="path" type="hidden" value="<?php echo $path; ?>" />
	<script>
		(function ($) {
