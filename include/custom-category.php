...
?>
	...
	<tr class="form-field">
		...
		<?php wp_editor( stripslashes($cat_meta['cps_meta_content']), 'cps_meta_content', array( 'media_buttons'=>true, 'textarea_name'=>'cps_meta[cps_meta_content]','textarea_rows'=>10,'tiny_mce'=>true) ); ?>
		</td>
	</tr>
